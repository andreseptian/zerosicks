...
<head>
  ...
  <link rel="stylesheet" href="<?= base_url('assets/dist/css/skins/skin-green.css'); ?>">
...
<body class="sidebar-mini hold-transition fixed skin-green sidebar-collapse">
  <!-- Site wrapper -->
  <div class="wrapper">
      ...
      <nav class="navbar navbar-static-top">
        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            ?>
            <li class="pull-left"><a><strong><?php echo "<span>" . hari_ini(date('w')) . ", " . tgl_indo(date('Y-m-d')) . " ~ <span id='jam'></span>"; ?></strong></a></li>
            <!-- User Account: style can be found in dropdown.less -->
            <li class="dropdown user user-menu">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <img src="<?php echo base_url(); ?>assets/file_upload/foto_profile/<?php echo $user->foto; ?>" class="user-image" alt="User Image">
      ...
      <section class="sidebar">
        ...
        <div class="user-panel">
          <div class="pull-left image">
            <img class="img-responsive img-circle" src="<?php echo base_url(); ?>assets/file_upload/foto_profile/<?php echo $user->foto; ?>" class="user-image" alt="User Image">
          </div>
